        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-2xl font-bold">Shark Cripto</h1>
          ...
          <div className="flex items-center gap-3">
            {isStatisticsPage ? <Button variant="outline" size="sm" onClick={() => navigate('/dashboard')} className="hidden sm:flex">
                <Home className="w-4 h-4 mr-2" />
                Dashboard
              </Button> : <Button variant="outline" size="sm" onClick={() => navigate('/statistics')} className="hidden sm:flex">
                <BarChart3 className="w-4 h-4 mr-2" />
                Estatísticas
              </Button>}

            <Button variant="outline" size="sm" onClick={() => setAlertsOpen(true)} className="hidden sm:flex relative">
              <Target className="w-4 h-4 mr-2" />
              Alertas
              {alerts.length > 0 && <Badge variant="default" className="absolute -top-2 -right-2 h-5 w-5 p-0 flex items-center justify-center text-xs bg-gold">
                  {alerts.length}
                </Badge>}
            </Button>

            <Button variant="outline" size="sm" onClick={() => setBlacklistOpen(true)} className="hidden sm:flex relative">
            ...
            <Button variant="outline" size="sm" onClick={() => setBankrollOpen(true)} className="hidden sm:flex">
            ...
            <Button variant="outline" size="icon" onClick={toggleTheme} className="hover-gold">
            ...
            {user && <>
                ...
                <Button variant="outline" size="icon" onClick={signOut} className="hover:bg-destructive hover:text-destructive-foreground" title="Sair">
